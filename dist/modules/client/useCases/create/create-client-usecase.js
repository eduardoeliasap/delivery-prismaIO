...
var prisma_client_1 = require("../../../../batabase/prisma-client");
var CreateClientuseCase = /** @class */ (function () {
    ...
    CreateClientuseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var clientExist, passwordHash, newClient;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, prisma_client_1.prisma.clients.findFirst({
                            where: {
                                username: username
                            }
                        })];
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, prisma_client_1.prisma.clients.create({
                                data: {
                                    username: username,
